...
class iosAlarmModule: NSObject, UNUserNotificationCenterDelegate {
...
//        setTargetTime()
        ...
        let soundName = UNNotificationSoundName(rawValue: "sample.wav")
